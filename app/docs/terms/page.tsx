  ...
  return (
    <div className="prose prose-slate max-w-none">
      ...
      <p className="text-slate-700 mb-6 leading-relaxed">
        These Terms of Service (&quot;Terms&quot;) govern your access to and use of TaxTicks, an automated invoice
      ...
      <p className="text-slate-700 mb-3">TaxTicks offers:</p>
      ...
      <ul className="list-disc pl-6 mb-6 space-y-2 text-slate-700">
        <li>
          You must be at least <strong className="text-slate-800">18 years old</strong> to use TaxTicks.
        </li>
        <li>
      ...
      <ul className="list-disc pl-6 mb-6 space-y-2 text-slate-700">
        <li>
          TaxTicks uses <strong className="text-slate-800">OpenAI (ChatGPT)</strong> and other third-party APIs to
      ...
      <ul className="list-disc pl-6 mb-6 space-y-2 text-slate-700">
        ...
        <li>
          TaxTicks does <strong className="text-slate-800">not claim any rights</strong> over your data.
        </li>
        <li>
      ...
      <ul className="list-disc pl-6 mb-6 space-y-2 text-slate-700">
        <li>
          TaxTicks is provided <strong className="text-slate-800">&quot;as is&quot;</strong>, without warranties of any
          kind.
        </li>
        <li>
