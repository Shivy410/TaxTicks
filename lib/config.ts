...
const config = {
  app: {
    title: "TaxTicks",
    description: "Your Taxes, Simplified.",
    version: process.env.npm_package_version || "0.0.1",
    baseURL: env.BASE_URL || `http://localhost:${env.PORT || "7331"}`,
    supportEmail: "support@taxticks.com",
  },
  upload: {
